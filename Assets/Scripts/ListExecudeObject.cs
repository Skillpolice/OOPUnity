...
{
    public sealed class ListExecudeObject : IEnumerable, IEnumerator
    {
        private IExecute[] _interactiveObjects;
        private int _index = -1;
        private InteractiveBaseClass _current;

        public ListExecudeObject()
        {
            var interactiveObjects = Object.FindObjectsOfType<InteractiveBaseClass>();
